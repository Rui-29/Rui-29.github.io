...
**Mar 2024** | [EnergyPlus  Tutorial](https://youtu.be/j1foofH0eRw?si=w0iuGnrGr_jQKXRX)  
    ...
    **Comments**: powerful lightweight simulation engine, better to utilize efficiency 
    
    has to combine with 3D modeling tools and more user-friendly interface to accelerate modeling speed.
### Papers/Seminars
